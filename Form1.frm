...
Begin VB.Form frmMain 
   ...
   Caption         =   "PyConsole Manager -Python控制台管理器"
   ClientHeight    =   3645
   ClientLeft      =   105
   ClientTop       =   435
   ClientWidth     =   7890
...
' 帮助按钮 - 显示详细操作说明
 MsgBox "【PyConsole Manager - Python脚本管理器】" & vbCrLf & vbCrLf & _
           "版本：1.0" & vbCrLf & vbCrLf & _
           "功能说明：" & vbCrLf & _
           "添加/删除Python脚本" & vbCrLf & _
           "启动/停止单个脚本" & vbCrLf & _
           "隐藏/显示CMD窗口" & vbCrLf & _
           "批量控制所有脚本" & vbCrLf & _
           "双击脚本快速启动/停止" & vbCrLf & vbCrLf & _
           "使用提示：" & vbCrLf & _
           "脚本会自动在所在目录运行" & vbCrLf & _
           "停止脚本会同时结束CMD和Python进程" & vbCrLf & _
           "关闭程序时会自动停止所有脚本" & vbCrLf & vbCrLf & _
           "2026", _
           vbInformation, "关于 PyConsole Manager"
End Sub
